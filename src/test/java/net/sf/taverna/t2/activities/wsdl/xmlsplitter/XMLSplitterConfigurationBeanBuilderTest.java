...
public class XMLSplitterConfigurationBeanBuilderTest {
	...
	public void testBuildBeanForInput() throws Exception  {
		...
		XMLSplitterConfigurationBean bean = XMLSplitterConfigurationBeanBuilder.buildBeanForInput(element);
		...
		assertEquals("The type xml definition should match",element,bean.getWrappedTypeXML());
	}
