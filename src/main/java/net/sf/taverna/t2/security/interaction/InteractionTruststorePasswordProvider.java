 ...
 *
 */
public class InteractionTruststorePasswordProvider implements
	...
	public InteractionTruststorePasswordProvider() {
		InteractionVelocity.checkVelocity();

			presentationTemplate = Velocity.getTemplate("TruststorePassword");
