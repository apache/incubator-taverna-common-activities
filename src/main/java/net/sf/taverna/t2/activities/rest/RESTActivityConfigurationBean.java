...
public class RESTActivityConfigurationBean implements Serializable {
	private static final List<String> knownHeaders = Arrays.asList("Accept", "Content-Type",
			"Expect");
	 ...
	 * validity; <br/>
	 * * <code>acceptsHeaderValue</code> and <code>contentTypeForUpdates</code> must not be empty. <br/>
	 * <br/>
