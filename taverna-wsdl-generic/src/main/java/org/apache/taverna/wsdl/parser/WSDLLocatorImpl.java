...
public class WSDLLocatorImpl implements WSDLLocator {
    ...
    public WSDLLocatorImpl(URL wsdlLocation) throws IOException  {
        baseURL = wsdlLocation;
        latestImportURI = baseURL.toString();
    }
    ...
    public InputSource getBaseInputSource() {
        try {
            ...
            Logger.getLogger(WSDLLocatorImpl.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
