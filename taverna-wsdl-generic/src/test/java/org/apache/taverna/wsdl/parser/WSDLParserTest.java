...
//		WSDLParser parser = new WSDLParser(wsdlResourcePath("eutils/eutils_lite.wsdl"));
//
//		LinkedHashMap<String,XmlSchemaNamed> inputs = parser
//				.getInputParameters("run_eInfo");
//		LinkedHashMap<String,XmlSchemaNamed> outputs = parser
//				.getOutputParameters("run_eInfo");
//
//		assertEquals("wrong number of inputs", 1, inputs.size());
//		assertEquals("wrong number of outputs", 1, outputs.size());
//                
//                XmlSchemaNamed input = inputs.values().iterator().next();
//		assertTrue("input should be complex", input instanceof XmlSchemaElement);
//                
//		XmlSchemaElement element = (XmlSchemaElement) input;
//		assertEquals("wrong name", "parameters", element.getName());
//		assertEquals("wrong number of elements", 3, element.
//				.getElements().size());
//
